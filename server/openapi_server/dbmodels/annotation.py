...
from openapi_server.dbmodels.text_location_annotation import TextLocationAnnotation  # noqa: E501
...
class Annotation(BaseDocument):
    ...
    textLocationAnnotations = EmbeddedDocumentListField(TextLocationAnnotation)  # noqa: E501
