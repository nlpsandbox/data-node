...
class Annotation(Model):
    ...
    def __init__(self, name=None, annotation_source=None, text_date_annotations=None, text_person_name_annotations=None, text_physical_address_annotations=None, text_id_annotations=None, text_contact_annotations=None, text_covid_symptom_annotations=None):  # noqa: E501
        ...
        :param text_covid_symptom_annotations: The text_covid_symptom_annotations of this Annotation.  # noqa: E501
    ...
    def text_id_annotations(self):
        """Gets the text_id_annotations of this Annotation.

        ID annotations in a text  # noqa: E501

        :return: The text_id_annotations of this Annotation.
    ...
    def text_id_annotations(self, text_id_annotations):
        """Sets the text_id_annotations of this Annotation.

        ID annotations in a text  # noqa: E501

        :param text_id_annotations: The text_id_annotations of this Annotation.
        :type text_id_annotations: List[TextIdAnnotation]
        """
    ...
    def text_contact_annotations(self):
        """Gets the text_contact_annotations of this Annotation.

        Contact annotations in a text  # noqa: E501

        :return: The text_contact_annotations of this Annotation.
    ...
    def text_contact_annotations(self, text_contact_annotations):
        """Sets the text_contact_annotations of this Annotation.

        Contact annotations in a text  # noqa: E501

        :param text_contact_annotations: The text_contact_annotations of this Annotation.
        :type text_contact_annotations: List[TextContactAnnotation]
        """
    ...
    def text_covid_symptom_annotations(self):
        """Gets the text_covid_symptom_annotations of this Annotation.

        COVID symptom annotations in a text  # noqa: E501

        :return: The text_covid_symptom_annotations of this Annotation.
    ...
    def text_covid_symptom_annotations(self, text_covid_symptom_annotations):
        """Sets the text_covid_symptom_annotations of this Annotation.

        COVID symptom annotations in a text  # noqa: E501

        :param text_covid_symptom_annotations: The text_covid_symptom_annotations of this Annotation.
        :type text_covid_symptom_annotations: List[TextCovidSymptomAnnotation]
        """
