...
class AnnotationCreateRequest(Model):
    ...
    def __init__(self, annotation_source=None, text_date_annotations=None, text_person_name_annotations=None, text_physical_address_annotations=None):  # noqa: E501
