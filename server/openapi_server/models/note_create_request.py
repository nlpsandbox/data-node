...
class NoteCreateRequest(Model):
    ...
    def __init__(self, text=None, type=None, patient_id=None):  # noqa: E501
        """NoteCreateRequest - a model defined in OpenAPI

        :param text: The text of this NoteCreateRequest.  # noqa: E501
        :type text: str
        :param type: The type of this NoteCreateRequest.  # noqa: E501
        :type type: str
    ...
    @property
    def type(self):
        """Gets the type of this NoteCreateRequest.

        The note type (LOINC concept)  # noqa: E501

        :return: The type of this NoteCreateRequest.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this NoteCreateRequest.

        The note type (LOINC concept)  # noqa: E501

        :param type: The type of this NoteCreateRequest.
        :type type: str
        """
        if type is None:
