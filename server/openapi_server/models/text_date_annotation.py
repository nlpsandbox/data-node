...
class TextDateAnnotation(Model):
    ...
    def __init__(self, name=None, annotation_source=None, annotation_type=None, start=None, length=None, text=None, date_format=None):  # noqa: E501
        """TextDateAnnotation - a model defined in OpenAPI

        :param name: The name of this TextDateAnnotation.  # noqa: E501
        :type name: str
    ...
    @property
    def name(self):
        """Gets the name of this TextDateAnnotation.

        Resource name of the annotation  # noqa: E501

        :return: The name of this TextDateAnnotation.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TextDateAnnotation.

        Resource name of the annotation  # noqa: E501

        :param name: The name of this TextDateAnnotation.
        :type name: str
        """
